...
export default function DefaulterListPage() {
  ...
  const fetchDefaulters = useCallback(async () => {
    try {
      const { data } = await axios.get('https://smart-rental-management.onrender.com/api/admin/defaulters');
      setDefaulters(data);
    } catch (err) {
  ...
  const notifyUser = async (userId) => {
    try {
      await axios.post(`https://smart-rental-management.onrender.com/api/admin/defaulters/notify`, { userId });
  ...
  const notifyDefaulter = async (tenantId) => {
    try {
      await axios.post(`https://smart-rental-management.onrender.com/api/admin/defaulters/notify`, { tenantId });
  ...
  const notifyAll = async () => {
    ...
    try {
      ...
      await Promise.all(
        defaulters.map((d) =>
          axios.post(`https://smart-rental-management.onrender.com/api/admin/defaulters/notify`, { userId: d._id })
        )
      );
